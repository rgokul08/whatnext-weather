...
export default function Home() {
  ...
  const jumpTo = (label: string) => { setActiveNav(label); const id = label === 'Forecast' ? 'forecast' : label === 'Live Layer' ? 'radar' : label === 'Favorites' ? 'saved' : label === 'Compare' ? 'compare' : 'top'; document.getElementById(id)?.scrollIntoView({ behavior: 'smooth' }); };
