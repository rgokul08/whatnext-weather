...
function MapView({ className, initialCenter = { lat: 37.7749, lng: -122.4194 }, initialZoom = 12, overlay = "none", onMapReady }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: cn("map-shell w-full h-[500px]", className) }, /* @__PURE__ */ React.createElement("div", { className: "map-fallback-grid" }, /* @__PURE__ */ React.createElement("span", null, "Interactive weather map"), /* @__PURE__ */ React.createElement("small", null, initialCenter.lat.toFixed(3), ", ", initialCenter.lng.toFixed(3))), /* @__PURE__ */ React.createElement("div", { ref: mapContainer, className: "map-canvas" }));
}
export {
  MapView
};
